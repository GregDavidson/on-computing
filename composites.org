...
#+begin_src racket
              ...
              (struct postal-address ([addressee: String] [location : String]))
              (define-type contact (U phone-number postal-address))
              ...
              (define john
                (people "John From"
                        (list (postal-address "General Delivery" "Fargo City ND"))
                        '(travel) ) )
              (define dana
                (people "Dana From"
                        (list (phone-number "+1 (203) 123-4567"))
                        '(reading) ) )
              (define nardles
                (company "Nardles, Inc."
                         (list john dana)
