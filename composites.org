...
A procedure's code doesn't run until it is
...
- [optionally] /side-effects/
      - modifying stored data outside of the procedure
...
Functional Programming is a popular computing paradigm
...
- take a value of type =people=
- return the value of their respective field (component)
- there can optionally be mutator procedures for changing field values
